...
DisplayGraph.java draws the graph. It can also show the MST(by prims) in the graph at a button press. (1991 algorithm of Fruchterman and Reingold implemented to Draw Graph)
...
The weight should be positive integers(The program has not been tested on negative weighted edges.)
The vertex names should be positive integers.
The graph should be connected.
The graph should not have multi-edged.

A sample graph file is included.
*****The graph format sent by TA works.
